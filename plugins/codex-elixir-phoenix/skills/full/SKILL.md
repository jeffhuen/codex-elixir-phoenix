...
5. **Review output is findings, not fixes** — Review tracks report issues. Only the WORKING state makes code changes
6. **Skip redundant review tracks** — In REVIEWING phase: skip
...
- `<skill-dir>/references/execution-steps.md` — Detailed step-by-step execution
- `<skill-dir>/references/example-run.md` — Example full cycle run
- `<skill-dir>/references/safety-recovery.md` — Safety rails, resume, rollback
- `<skill-dir>/references/cycle-patterns.md` — Advanced cycling strategies
