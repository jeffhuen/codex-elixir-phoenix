...
description: "Use when a Phoenix app is running with Tidewave MCP and runtime debugging, smoke testing, state inspection, SQL queries, or version-matched docs would help."
---
...
See `<skill-dir>/references/proactive-patterns.md` for full integration points.

## References

For detailed patterns, see:

- `<skill-dir>/references/proactive-patterns.md` - Push-like runtime patterns at workflow checkpoints
- `<skill-dir>/references/tool-examples.md` - Complete tool usage examples
- `<skill-dir>/references/validation-checklist.md` - Runtime validation patterns
