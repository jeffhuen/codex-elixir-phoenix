---
name: phx-examples
description: "Use when the user asks for Phoenix, LiveView, Ecto, Oban, OTP, or testing examples, walkthroughs, or what a pattern should look like."
---
...
```bash
# 1. Plan feature with specialist tracks
...
This plugin enforces non-negotiable rules across all Codex work:
