---
name: ecto-patterns
description: "Use when editing Ecto schemas, changesets, queries, migrations, Repo calls, Ecto.Multi, associations, preloads, or upserts; skip for Ash."
---
...
- `<skill-dir>/references/changesets.md` - cast vs put_change, custom validations, prepare_changes
- `<skill-dir>/references/queries.md` - Composable queries, dynamic, subqueries, preloading
- `<skill-dir>/references/migrations.md` - Safe migrations, concurrent indexes, NOT NULL
- `<skill-dir>/references/transactions.md` - Repo.transact, Ecto.Multi, upserts
