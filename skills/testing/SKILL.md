---
name: testing
description: "Use when working on Elixir ExUnit tests, LiveView tests, Mox, factories, test/support, async tests, fixtures, or test failures."
---
...
- `<skill-dir>/references/exunit-patterns.md` - Setup, assertions, tags
- `<skill-dir>/references/mox-patterns.md` - Behaviours, expect/stub, async
- `<skill-dir>/references/liveview-testing.md` - Forms, async, uploads
- `<skill-dir>/references/factory-patterns.md` - ExMachina, sequences, traits
