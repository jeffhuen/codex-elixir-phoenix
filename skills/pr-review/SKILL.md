---
name: phx-pr-review
description: "Use when the user shares a PR URL/number or asks to address reviewer feedback, draft responses, inspect comments, or optionally fix Elixir/Phoenix code."
---
...
`<skill-dir>/references/response-patterns.md`.
...
- `<skill-dir>/references/response-patterns.md` — Response templates and common patterns
