---
name: deploy
description: "Use when configuring Elixir/Phoenix deployment, Dockerfile, fly.toml, runtime.exs, mix releases, rel overlays, CI/CD, health checks, or production migrations."
---
...
- `<skill-dir>/references/docker-config.md` - Multi-stage Dockerfile, best practices
- `<skill-dir>/references/flyio-config.md` - fly.toml, clustering, commands
