---
name: elixir-idioms
description: "Use when designing OTP/BEAM processes, GenServers, Supervisors, Tasks, Registry usage, pattern matching, with chains, pipes, or debugging BEAM behavior."
---
...
- `<skill-dir>/references/pattern-matching.md` - Pattern matching, guards, binary matching
- `<skill-dir>/references/otp-patterns.md` - GenServer, Supervisor, Task, Registry
- `<skill-dir>/references/error-handling.md` - Tagged tuples, rescue, with
- `<skill-dir>/references/with-and-pipes.md` - When to use `with` and `|>` (idiomatic patterns)
- `<skill-dir>/references/troubleshooting.md` - Production BEAM debugging (memory, performance, crashes)
