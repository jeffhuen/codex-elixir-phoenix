---
name: phx-quick
description: "Use when making a small Elixir/Phoenix change, usually single-file or under roughly 50 lines, where a full plan would add unnecessary overhead."
---
...
|-------------|------------|
| Run broad research tracks | No broad research |
