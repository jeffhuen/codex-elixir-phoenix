---
name: security
description: "Use when editing or reviewing Elixir/Phoenix auth, OAuth, sessions, CSRF, XSS, SQL injection, input validation, secrets, RBAC, or API key handling."
---
...
- `<skill-dir>/references/authentication.md` - phx.gen.auth, MFA, sessions
- `<skill-dir>/references/authorization.md` - Bodyguard, scopes, LiveView auth
- `<skill-dir>/references/input-validation.md` - Changesets, file uploads, paths
- `<skill-dir>/references/security-headers.md` - CSP, CSRF, rate limiting, headers
- `<skill-dir>/references/oauth-linking.md` - OAuth account linking, token management
- `<skill-dir>/references/rate-limiting.md` - Composite key strategies, Hammer patterns
- `<skill-dir>/references/advanced-patterns.md` - SSRF prevention, secrets management, supply chain
