---
name: phx-compound
description: "Use when a bug fix, review finding, investigation finding, or user-confirmed solution should be captured as reusable knowledge."
---
...
- `<skill-dir>/references/compound-workflow.md` — Detailed step-by-step
