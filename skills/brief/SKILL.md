---
name: phx-brief
description: "Use when the user needs to understand a plan file, including reasoning, schema decisions, component choices, risks, or approval context."
---
...
(see `<skill-dir>/references/briefing-guide.md` Visual Formatting). After each
...
See `<skill-dir>/references/briefing-guide.md` for section content templates.
...
`<skill-dir>/references/visual-explainer.md` for thresholds and commands.
