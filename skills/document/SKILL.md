---
name: phx-document
description: "Use when explicitly asked to write Elixir @doc or @moduledoc for modules, contexts, schemas, or functions; not for README or external docs."
---
...
- `<skill-dir>/references/doc-templates.md` — @moduledoc, @doc, README, ADR templates
- `<skill-dir>/references/output-format.md` — Documentation report format
- `<skill-dir>/references/doc-best-practices.md` — Elixir documentation best practices
- `<skill-dir>/references/documentation-patterns.md` — Detailed documentation patterns
