...
description: "Use when building or reviewing Phoenix LiveView interactions, assign_async, PubSub, connected? checks, phx-change, streams, forms, uploads, components, JS interop, or Presence."
---
...
- `<skill-dir>/references/async-streams.md` - assign_async, stream_async, streams
- `<skill-dir>/references/forms-uploads.md` - Forms, validation, file uploads
- `<skill-dir>/references/components.md` - Function components, LiveComponents
- `<skill-dir>/references/pubsub-navigation.md` - PubSub, navigation, JS commands
- `<skill-dir>/references/js-interop.md` - Third-party JS libraries, phx-update="ignore", hooks
- `<skill-dir>/references/channels-presence.md` - Phoenix Channels, Presence, token auth
