...
1. **Quick Codebase Scan** (30-60 seconds):
   - Run `phoenix-patterns-analyst` for focused analysis
...
2. **Assess Complexity**:
   ...
   | 7-10 | HIGH | "research it" -> Comprehensive planning (4+ tracks) |
...
- Run research tracks (1-2 for standard, 4+ for comprehensive)
...
Run 4 review tracks. Delegate them only when Codex subagents are available and
authorized; otherwise run them inline:
